import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@merge-ai/sdk/v2"
import { SessionTurn } from "@merge-ai/ui/session-turn"
import { SessionReview } from "@merge-ai/ui/session-review"
import { DataProvider } from "@merge-ai/ui/context"
import { FileComponentProvider } from "@merge-ai/ui/context/file"
import { WorkerPoolProvider } from "@merge-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@merge-ai/ui/logo"
import { IconButton } from "@merge-ai/ui/icon-button"
import { ProviderIcon } from "@merge-ai/ui/provider-icon"
import { iife } from "@merge-ai/util/iife"
import { Binary } from "@merge-ai/util/binary"
import { NamedError } from "@merge-ai/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@merge-ai/ui/tabs"
import { MessageNav } from "@merge-ai/ui/message-nav"
import { FileSSR } from "@merge-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@merge-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/merge-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Merge</Title>
              </Show>
              <Meta name="description" content="merge - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/merge"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
