...
import { ResizeHandle } from "@merge-ai/ui/resize-handle"
import { Button } from "@merge-ai/ui/button"
import { IconButton } from "@merge-ai/ui/icon-button"
import { Tooltip } from "@merge-ai/ui/tooltip"
import { DropdownMenu } from "@merge-ai/ui/dropdown-menu"
import { Dialog } from "@merge-ai/ui/dialog"
import { getFilename } from "@merge-ai/util/path"
import { Session, type Message } from "@merge-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@merge-ai/ui/toast"
...
import { retry } from "@merge-ai/util/retry"
...
import { useTheme, type ColorScheme } from "@merge-ai/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://merge.ai/desktop-feedback")}
      renderPanel={() =>
