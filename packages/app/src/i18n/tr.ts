...
export const dict = {
  ...
  "dialog.provider.merge.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.merge.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.mergeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Merge tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Merge'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.mergeZen.line1":
    "Merge Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.mergeZen.visit.prefix": "",
  "provider.connect.mergeZen.visit.link": "merge.ai/zen",
  "provider.connect.mergeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Merge'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Merge'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler merge.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Merge sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Merge'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Merge ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (merge.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Merge henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Merge ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Merge Masaüstü",
  ...
  "settings.desktop.wsl.description": "Merge sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Merge'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Merge'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Merge'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Merge'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Merge başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Merge'un en son sürümünü kullanıyorsunuz.",
