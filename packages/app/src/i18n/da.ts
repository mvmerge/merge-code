export const dict = {
  ...
  "dialog.provider.merge.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.merge.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.mergeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Merge",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Merge.",
  ...
  "provider.connect.mergeZen.line1":
    "Merge Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.mergeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.mergeZen.visit.prefix": "Besøg ",
  "provider.connect.mergeZen.visit.link": "merge.ai/zen",
  "provider.connect.mergeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Merge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Merge.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i merge.json",
  ...
  "dialog.server.description": "Skift hvilken Merge-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Merge ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Merge-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (merge.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Merge understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Merge inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Merge-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Merge",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Merge ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Merge følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Merge er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Merge starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Merge.",
