...
beforeAll(async () => {
  ...
  mock.module("@merge-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@merge-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@merge-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@merge-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
