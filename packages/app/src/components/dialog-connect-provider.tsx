  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "merge"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.mergeZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.mergeZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.mergeZen.visit.prefix")}
                <Link href="https://merge.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.mergeZen.visit.link")}
                </Link>
                {language.t("provider.connect.mergeZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
