import { createOpencodeClient } from "@merge-ai/sdk/v2/client"
import { base64Encode, checksum } from "@merge-ai/util/encode"
...
export function workspacePersistKey(directory: string, key: string) {
  ...
  return `merge.workspace.${head}.${sum}.dat:workspace:${key}`
}
