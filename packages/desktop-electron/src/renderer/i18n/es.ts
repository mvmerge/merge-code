export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Merge",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Merge. ¿Quieres instalarla y reiniciar?",
