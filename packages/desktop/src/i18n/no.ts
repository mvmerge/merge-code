export const dict = {
  ...
  "desktop.menu.help.documentation": "Merge Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Merge CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
