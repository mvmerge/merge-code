...
const releaseId = process.env.MERGE_RELEASE
if (!releaseId) throw new Error("MERGE_RELEASE is required")

const version = process.env.MERGE_VERSION
if (!releaseId) throw new Error("MERGE_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "merge-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "merge-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "merge-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "merge-desktop-linux-aarch64.rpm" },
  { key: "windows-aarch64-nsis", asset: "merge-desktop-windows-arm64.exe" },
  { key: "windows-x86_64-nsis", asset: "merge-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "merge-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "merge-desktop-darwin-aarch64.app.tar.gz",
  },
]
