  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all Merge sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific Merge session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new Merge session for interacting with AI assistants and managing conversations.",
