...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders MERGE_CALLER", () => {
    process.env["MERGE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode MERGE_CALLER", () => {
    process.env["MERGE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown MERGE_CALLER", () => {
    process.env["MERGE_CALLER"] = "unknown"
