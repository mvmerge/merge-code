...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/merge.git")).toEqual({ owner: "sst", repo: "merge" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/merge")).toEqual({ owner: "sst", repo: "merge" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/merge.git")).toEqual({ owner: "sst", repo: "merge" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/merge")).toEqual({ owner: "sst", repo: "merge" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/merge.git")).toEqual({ owner: "sst", repo: "merge" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/merge")).toEqual({ owner: "sst", repo: "merge" })
})
