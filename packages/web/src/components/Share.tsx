...
import type { MessageV2 } from "merge/session/message-v2"
import type { Message } from "merge/session/message"
import type { Session } from "merge/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.merge_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.merge_name}>
