...
import desktopAppIcon from "../../asset/lander/merge-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://merge.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>merge.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g merge-ai")}>
                <code>
                  npm i -g <strong>merge-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g merge-ai")}>
                <code>
                  bun add -g <strong>merge-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/merge")}>
                <code>
                  brew install <strong>anomalyco/tap/merge</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S merge")}>
                <code>
                  paru -S <strong>merge</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask merge-desktop")}>
                <code>
                  brew install --cask <strong>merge-desktop</strong>
                </code>
                <CopyStatus />
              </button>
