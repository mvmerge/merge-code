...
import { and, Database, eq, isNull, lt, or, sql } from "@merge-ai/console-core/drizzle/index.js"
import { KeyTable } from "@merge-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@merge-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@merge-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@merge-ai/console-core/util/date.js"
import { Identifier } from "@merge-ai/console-core/identifier.js"
import { Billing } from "@merge-ai/console-core/billing.js"
import { Actor } from "@merge-ai/console-core/actor.js"
import { WorkspaceTable } from "@merge-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@merge-ai/console-core/model.js"
import { Subscription } from "@merge-ai/console-core/subscription.js"
import { BlackData } from "@merge-ai/console-core/black.js"
import { UserTable } from "@merge-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@merge-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@merge-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@merge-ai/console-core/lite.js"
import { Resource } from "@merge-ai/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-merge-session") ?? ""
    const requestId = input.request.headers.get("x-merge-request") ?? ""
    const projectId = input.request.headers.get("x-merge-project") ?? ""
    const ocClient = input.request.headers.get("x-merge-client") ?? ""
    logger.metric({
      is_stream: isStream,
      session: sessionId,
      request: requestId,
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-merge-request")
          headers.delete("x-merge-session")
          headers.delete("x-merge-project")
          headers.delete("x-merge-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    const billingUrl = `https://merge.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://merge.ai/workspace/${authInfo.workspaceID}/members`
