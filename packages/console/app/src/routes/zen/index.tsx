...
import compareVideo from "../../asset/lander/merge-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/merge-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="merge:auth" content={loggedin() ? "true" : "false"} />
