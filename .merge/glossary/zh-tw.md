...
- PR #13942: https://github.com/anomalyco/merge/pull/13942

## Do Not Translate (Locale Additions)

- `Merge` (preserve casing in prose; keep `merge` only when it is part of commands, package names, paths, or code)
- `Merge Zen`
- `Merge CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `merge` in prose when referring to the product name; use `Merge`
