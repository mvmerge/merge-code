...
- PR #10018: https://github.com/anomalyco/merge/pull/10018
- PR #12935: https://github.com/anomalyco/merge/pull/12935

## Do Not Translate (Locale Additions)

- `Merge` (preserve casing in prose; keep `merge` only in commands, package names, paths, or code)
- `Merge CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
