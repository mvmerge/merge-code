...
Use this folder for locale-specific translation guidance that supplements `.merge/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/merge/pull/12345

## Do Not Translate (Locale Additions)

- `Merge` (preserve casing)
