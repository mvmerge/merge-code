...
- PR #15835: https://github.com/anomalyco/merge/pull/15835

## Do Not Translate (Locale Additions)

- `Merge` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `merge` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Merge` in prose, `merge` only for exact technical identifiers
...
- Avoid changing `merge` to `Merge` inside commands, URLs, package names, or code literals
